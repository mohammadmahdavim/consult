    ...
    <main class="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h3>ایجاد رضایت جدید</h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/panel/home">داشبورد</a></li>
                            <li class="breadcrumb-item active" aria-current="page">ایجاد رضایت جدید</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ایجاد رضایت جدید</h5>
                            <form action="/panel/satisfaction" class="needs-validation" novalidate method="post"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="month" name="month"
                                               placeholder="تعداد ماه" required value="{{old('month')}}">
                                        <div class="valid-tooltip">
                                            صحیح است!
                                        </div>
                                    </div>
