        ...
        <div class="container-fluid">
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">ویرایش بلاگ جدید</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ویرایش بلاگ </h5>
                            <form action="/panel/home/blog/{{$row->id}}" class="needs-validation" novalidate
                                  method="post"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select class="form-control" name="writer">
                                            @foreach($users as $user)
                                                <option @if($row->writer==$user->id) selected
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select  class="js-example-basic-single" name="tag[]" multiple>
                                            ...
                                            @foreach($tags as $tag)
                                                <option  @if(in_array($tag->id, $row->tag->pluck('id')->toArray())) selected @endif   value="{{$tag->id}}">{{$tag->title}}</option>
                                            @endforeach
