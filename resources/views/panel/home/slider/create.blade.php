        ...
        <div class="container-fluid">
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">ایجاد اسلایدر جدید</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">ایجاد اسلایدر جدید</h5>
                            <form action="/panel/home/slider" class="needs-validation" novalidate method="post"
